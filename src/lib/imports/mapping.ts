...
const aliases: Record<ImportField, string[]> = {
  supplierSku: ["codice art", "codice articolo", "codice fornitore", "supplier code", "supplier sku", "sku", "codice"],
  manufacturerSku: ["codice produttore", "manufacturer sku", "mfr sku"],
  ean: ["ean", "gtin", "barcode"],
  description: ["descrizione", "descrizione articolo", "product description", "description", "prodotto", "articolo"],
  ...
  unitsPerPackage: ["pz/conf", "pezzi confezione", "unità confezione", "qta conf", "units per pack", "box qty", "box", "fattore"],
  ...
  netPrice: ["prezzo netto", "prezzo unitario", "unit price", "prezzo", "net price", "price"], taxRate: ["iva", "aliquota iva", "vat"],
