...
export const navigationByRole: Record<RoleCode, { label: string; href: string }[]> = {
  ...
  PROCUREMENT_MANAGER: [{ label: "Control Center", href: "/" }, { label: "Da gestire", href: "/approvals" }, { label: "Prodotti", href: "/products" }, { label: "Categorie", href: "/categorie" }, { label: "Fornitori", href: "/suppliers" }, { label: "Listini", href: "/price-lists" }, { label: "Confronto prezzi", href: "/compare" }, { label: "Ordini", href: "/orders" }, { label: "Non conformità", href: "/non-conformita" }, { label: "Budget", href: "/budget" }],
  PROCUREMENT_ADMIN: [{ label: "Home", href: "/" }, { label: "Organizzazione", href: "/organization" }, { label: "Utenti e poteri", href: "/users" }, { label: "Deleghe", href: "/deleghe" }, { label: "Prodotti", href: "/products" }, { label: "Categorie", href: "/categorie" }, { label: "Fornitori", href: "/suppliers" }],
