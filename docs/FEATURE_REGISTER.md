...
| Product 360 | Recovery | DONE | 95% | `/products/[id]` | Specifiche, offerte, storico DB, utilizzo, documenti, alternative |
...
| Supplier 360 | Hardening | DONE | 92% | `/suppliers/[id]` | Dipendenza trasparente, trend, prezzo, termini, contatti, delivery e qualità con campione |
...
| Category 360 | Recovery | DONE | 90% | `/categorie/[id]` | Spesa, budget, fornitori, opportunità |
...
| Executive Control Tower | V1 | DONE | 85% | `/control-tower` | Valore operativo; confronto organizzazioni da approfondire |
