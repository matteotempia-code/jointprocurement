...
export default async function opening(scene) {
  await scene.beat(
    "rsa-home",
    "La piattaforma si apre sull'ambiente operativo della struttura.",
    "Una sola piattaforma parte dal lavoro quotidiano della struttura.",
    async () => {
  ...
  await scene.beat(
    "procurement-role",
    "Il cambio persona rivela il Centro di controllo Procurement.",
    "La stessa base dati cambia profondità per chi governa fornitori e prezzi.",
    async () => {
  ...
  await scene.beat(
    "executive-role",
    "La vista Executive riduce l'operatività a sintesi direzionale.",
    "La direzione vede rischi e opportunità senza rumore operativo.",
    async () => {
