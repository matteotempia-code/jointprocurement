...
export default async function executive(scene) {
  await scene.beat(
    "executive-home",
    "Davide entra nella sintesi direzionale.",
    "La Control Tower riduce il sistema a pochi indicatori con definizioni coerenti.",
    async () => {
  ...
  await scene.beat(
    "opportunities",
    "Le principali opportunità sono limitate alle più significative.",
    "La direzione vede dove si crea valore senza dettagli operativi minuti.",
    async () => {
  ...
  await scene.beat(
    "risks",
    "I rischi operativi e commerciali completano la lettura.",
    "Ritardi, qualità e conformità restano leggibili nello stesso quadro.",
    async () => {
  ...
  await scene.beat(
    "organizations",
    "Anteo e Coopselios sono confrontate senza perdere il perimetro comune.",
    "Il modello joint mantiene separazione organizzativa e visione aggregata.",
    async () => {
